/**
 * EthicFlow — Admin Dashboard (placeholder)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {[
          { label: t('dashboard.admin.totalUsers'),   value: 24, color: 'var(--lev-navy)' },
          { label: t('dashboard.admin.systemHealth'), value: '✅', color: '#16a34a' },
