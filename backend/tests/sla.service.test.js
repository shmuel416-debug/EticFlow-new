 ...
 * Verifies SLA escalation queries match the multi-role user schema.
 */
...
describe('sla.service runSlaCheck', () => {
  beforeEach(() => {
    ...
    statusServiceMock.getNonTerminalCodes.mockResolvedValue(['SUBMITTED', 'IN_TRIAGE'])
  })

  test('loads escalation users through roles array filtering', async () => {
    await runSlaCheck()
